...
for N in range(N_min, N_max+1):
    ...
    print("Current timestep: ", t_total, " / ", t_total)
    ...
    #
    dirName = "train_samples=" + str(train_num_samples) + "_timestep=" + str(t) + "_t_total=" + str(t_total)
    ...
    plt.grid()
    plt.savefig(dirName + "/Coeff_N_" + str(N) + "_timestep_" + str(t) + "_(real).png")
    plt.clf()
    ...
    plt.gca().legend(["exp(-iHt)", "NN"])
    plt.grid()
    plt.savefig(dirName + "/Coeff_N_" + str(N) + "_timestep_" + str(t) + "_(imag).png")
    plt.clf()
    ...
    plt.grid()
    plt.savefig(dirName + "/Corr_N_" + str(N) + "_timestep_" + str(t) + "_(real).png")
    plt.clf()
    ...
    plt.xlim(xmin=0, xmax=x_max)
    plt.grid()
    plt.savefig(dirName + "/Corr_N_" + str(N) + "_timestep_" + str(t) + "_(imag).png")
    plt.clf()
...
plt.xlim(xmin=0, xmax=x_max)
plt.grid()
plt.savefig(dirName + "/Overlap_timestep_" + str(t) + ".png")
