...
dir_name = "norm_each_layer_dropout_activation=" + activation
...
if path.exists(best_model_filename):
    ...
    normalization_0 = Lambda(lambda t: l2_normalize(100000*t, axis=1))(dropout_layer_0)
    hidden_layer_1 = Dense(2*(2**N), activation=activation)(normalization_0)
    dropout_layer_1 = Dropout(.2, input_shape=(2,))(hidden_layer_1)
    normalization_1 = Lambda(lambda t: l2_normalize(100000*t, axis=1))(dropout_layer_1)
    hidden_layer_2 = Dense(2*(2**N), activation=activation)(normalization_1)
    dropout_layer_2 = Dropout(.2, input_shape=(2,))(hidden_layer_2)
    normalization_2 = Lambda(lambda t: l2_normalize(100000*t, axis=1))(dropout_layer_2)
    hidden_layer_3 = Dense(2*(2**N), activation=activation)(normalization_2)
    dropout_layer_3 = Dropout(.2, input_shape=(2,))(hidden_layer_3)
    output = Lambda(lambda t: l2_normalize(100000*t, axis=1))(dropout_layer_3)
