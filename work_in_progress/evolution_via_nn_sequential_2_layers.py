...
for N in range(N_min, N_max+1):
    ...
    output = Lambda(lambda t: l2_normalize(1000*t, axis=1))(hidden_layer_2)
    # ==============================================================================
    ...
    #
    # Check how this network behawes for longer evolution times
    #

    ############################################################################
    x = list(np.arange(t, (3*t_total)+t, t))
    x_max = x[-1]
    y_overlap = []
    ############################################################################
    ...
    #
    dirName = "2_layers_simple_train_samples=" + str(train_num_samples) + "_timestep=" + str(t) + "_t_total=" + str(t_total)  + "_optimizer=" + optimizer + "_loss=" + loss + "_activation=" + activation
    ...
    file.write("Type: 2 layers, simple (NOT encoder-decoder)\n")
    ...
    plt.title("Coefficient (imaginary) - 2 layers (simple) \nN: " + str(N) + " timestep: " + str(t) + " training set size: " + str(train_num_samples) + "\noptimizer: " + optimizer + " loss: " + loss + " activation: " + activation)
    ...
    plt.title("Mean correlation (real) - 2 layers (simple) \nN: " + str(N) + " timestep: " + str(t) + " training set size: " + str(train_num_samples) + "\noptimizer: " + optimizer + " loss: " + loss + " activation: " + activation)
    ...
    plt.title("Mean correlation (imaginary) - 2 layers (simple) \nN: " + str(N) + " timestep: " + str(t) + " training set size: " + str(train_num_samples) + "\noptimizer: " + optimizer + " loss: " + loss + " activation: " + activation)
