...
dir_name = "norm_each_layer_activation=" + activation
...
if path.exists(best_model_filename):
    ...
    normalization_0 = Lambda(lambda t: l2_normalize(100000*t, axis=1))(hidden_layer_0)
    hidden_layer_1 = Dense(2*(2**N), activation=activation)(normalization_0)
    normalization_1 = Lambda(lambda t: l2_normalize(100000*t, axis=1))(hidden_layer_1)
    hidden_layer_2 = Dense(2*(2**N), activation=activation)(normalization_1)
    normalization_2 = Lambda(lambda t: l2_normalize(100000*t, axis=1))(hidden_layer_2)
