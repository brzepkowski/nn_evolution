...
def conduct_exact_evol_and_gen_sets(N, dt, t_max):
    ...
    with open(dir_name + '/training_input.npy', 'wb') as f:
    ...
    with open(dir_name + '/training_output.npy', 'wb') as f:
    ...
    with open(dir_name + '/validation_input.npy', 'wb') as f:
    ...
    with open(dir_name + '/validation_output.npy', 'wb') as f:
