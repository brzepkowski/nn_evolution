...
from nn_evolution.neural_networks.train_evol_compress import train_evol_compress
from nn_evolution.neural_networks.test_evol_compress import test_evol_compress
import sys
...
if __name__ == "__main__":
    ...
    while subtracted_neurons <= (2**N):
        train_evol_compress(activation, N, dt, t_max, subtracted_neurons)
