...
if path.exists(model_filename):
    ...
    hidden_layer_1 = Dense(2*(2**N)-2, activation=activation)(hidden_layer_0)
    dropout_layer_1 = Dropout(.2, input_shape=(2,))(hidden_layer_1)
    hidden_layer_2 = Dense(2*(2**N)-2, activation=activation)(hidden_layer_1)
...
file.write("Type: 4 simple layers ENCODER-DECODER with subtracted 2 neurons; normalization ONLY after last layer\n")
