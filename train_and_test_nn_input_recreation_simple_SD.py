...
from nn_evolution_splitted_dataset.neural_networks.train_input_recreation_simple import train_input_recreation_simple
from nn_evolution_splitted_dataset.neural_networks.test_input_recreation_simple import test_input_recreation_simple
import sys
...
if __name__ == "__main__":
    ...
    for set_number in range(number_of_datasets):
        train_input_recreation_simple(activation, N, dt, t_max, set_number)
