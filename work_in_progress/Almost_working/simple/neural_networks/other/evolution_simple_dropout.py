...
dir_name = "simple_dropout_activation=" + activation
...
if path.exists(best_model_filename):
    ...
    hidden_layer_1 = Dense(2*(2**N), activation=activation)(dropout_layer_0)
    dropout_layer_1 = Dropout(.2, input_shape=(2,))(hidden_layer_1)
    hidden_layer_2 = Dense(2*(2**N), activation=activation)(dropout_layer_1)
    dropout_layer_2 = Dropout(.2, input_shape=(2,))(hidden_layer_2)
    hidden_layer_3 = Dense(2*(2**N), activation=activation)(dropout_layer_2)
